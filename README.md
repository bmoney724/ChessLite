...
* <ins>Windows Installer:</ins> installer for windows contained [here](https://github.com/JosephPrichard/ChessLiteGUI/blob/master/dist/ChessLite_Installer.exe)... works without jre
