# ChessLiteGUI
ChessLite is a lightweight Chess GUI for playing Chess on a personal computer. <br>
ChessLite is written in Java, and built with JavaFX. <br>
ChessLite does not depend on any libraries aside from Java and JavaFX API! <br>
All ChessLite algorithms were written for this project by Joseph Prichard. <br>
